...
* The following workspace dependencies were updated
  * dependencies
    * noosphere bumped from 0.8.0 to 0.9.0

* The following workspace dependencies were updated
  * dependencies
    * noosphere bumped from 0.9.0 to 0.10.0

* The following workspace dependencies were updated
  * dependencies
    * noosphere bumped from 0.10.0 to 0.11.0
...
* The following workspace dependencies were updated
  * dependencies
    * noosphere bumped from 0.13.0 to 0.14.0

* The following workspace dependencies were updated
  * dependencies
    * noosphere bumped from 0.15.0 to 0.16.0
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * noosphere bumped from 0.14.0 to 0.15.0
