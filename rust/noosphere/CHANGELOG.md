...
* The following workspace dependencies were updated
  * dependencies
    ...
    * noosphere-into bumped from 0.11.5 to 0.11.6
  * dev-dependencies
    * noosphere-core bumped from 0.18.0 to 0.18.1

## [0.16.2](https://github.com/subconsciousnetwork/noosphere/compare/noosphere-v0.16.1...noosphere-v0.16.2) (2024-03-26)
