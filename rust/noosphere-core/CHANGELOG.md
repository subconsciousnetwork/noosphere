...
## [0.12.0](https://github.com/subconsciousnetwork/noosphere/compare/noosphere-core-v0.11.0...noosphere-core-v0.12.0) (2023-05-08)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * noosphere-collections bumped from 0.5.3 to 0.5.4
